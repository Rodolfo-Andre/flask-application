...
class PetForm(FlaskForm):
  ...
  owner_dni = StringField('Dni del propietario: ', validators=[DataRequired("Ingrese el dni del propietario"), Length(min=8, max=8,message="El dni debe contener 8 dígitos"), Regexp("^[0-9]{8}$", message="Introduce un dni válido")])
